...
from tensorflow.python.keras.layers import BatchNormalization, Activation, ZeroPadding2D, MaxPool2D
...
if __name__ == '__main__':
    ...
    adv_data_path = './images/fgsm_adv.png'
    adv_label_path = ''
    adv_test_data_path = ''
    adv_test_label_path = ''
    ...
    # model.summary()
    model.load_weights(".\model\mnist_cnn1.h5")
